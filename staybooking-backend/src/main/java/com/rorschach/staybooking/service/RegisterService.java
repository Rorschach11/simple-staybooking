...
import com.rorschach.staybooking.exception.UserAlreadyExistException;
...
import com.rorschach.staybooking.repository.UserRepository;
...
public class RegisterService {
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE) //保证两个操作一起成功或失败
